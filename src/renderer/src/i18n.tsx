...
const en = {
  ...
  filter_blur: 'Blur',
  filter_bright: 'Brighten',
  filter_dark: 'Darken',
  filter_contrast: 'Contrast',
  filter_saturate: 'Vibrant',
  ...
  filter_upside_down: 'Upside Down',
...
const fr: typeof en = {
  ...
  filter_none: 'Aucun',
  filter_grayscale: 'Gris',
  filter_sepia: 'Sépia',
  filter_invert: 'Négatif',
  filter_blur: 'Flou',
  ...
  filter_saturate: 'Vif',
  filter_hue: 'Teinte',
  filter_vintage: 'Ancien',
  filter_noir: 'Noir',
  filter_dramatic: 'Dramatique',
  filter_cold: 'Froid',
  filter_warm: 'Chaud',
  filter_mirror: 'Miroir',
  filter_upside_down: 'Renversé',
